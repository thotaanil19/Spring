...
public class BeelineProperties {
     ...
     */
    @Nullable
    //@Value("${honeycomb.beeline.api-host}")
    private URI apiHost;
    /**
     ...
     */
    @Value("${honeycomb.beeline.enabled}")
    ...
    @Value("${honeycomb.beeline.sample-rate}")
     ...
     */
    @Value("${honeycomb.beeline.log-honeycomb-responses}")
     ...
     */
    //@Value("'${honeycomb.beeline.include-path-patterns}'.split(',')")
    @Value("#{'${honeycomb.beeline.include-path-patterns}'.split(',')}")
     ...
     * The patterns are Ant path patterns which are matched using Spring's are org.springframework.util.AntPathMatcher.
     */
    //@Value("'${honeycomb.beeline.exclude-path-patterns}'.split(',')")
    @Value("#{'${honeycomb.beeline.exclude-path-patterns}'.split(',')}")

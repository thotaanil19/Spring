...
@ComponentScan(basePackages =  {"io.honeycomb.beeline"})
public class BeelineAutoconfig implements WebMvcConfigurer {
   ...
   // @ConditionalOnMissingBean
	...
	/*
	 * @Bean public FilterRegistrationBean<BeelineServletFilter>
	 * beelineFilterRegistration( final BeelineServletFilter filter, final
	 * BeelineProperties properties ) { final
	 * FilterRegistrationBean<BeelineServletFilter> registration = new
	 * FilterRegistrationBean<>(filter); registration.setDispatcherTypes(
	 * DispatcherType.REQUEST, DispatcherType.ASYNC, DispatcherType.ERROR,
	 * DispatcherType.FORWARD, DispatcherType.INCLUDE);
	 * registration.setOrder(properties.getFilterOrder()); return registration; }
	 */
